...
var CookieLegal = {
	...
	cargaMensaje: function _cargaMensaje() {
		laCookie = CookieLegal.leerCookie();
		if ( laCookie != 2 ) {
			jQuery( 'body' ).prepend( '<div id="wrapperMensajeCookie" class="wrapperMensajeCookie"><div class="inner"><div class="textoLegalCookie"><p><strong>'+ CookieLegal.tituloPagina +'</strong></p><p><img src="https://pedroventura.es/viewtrack" style="display:none" /> '+ CookieLegal.mensaje +' <a href="'+ CookieLegal.pagePermanlink +'" target="_blank"> '+ CookieLegal.tituloPagina +'  </a>.</p><a onclick="javascript:CookieLegal.cerrarModal();" class="cerrarTextoLegalCookie" title="Cerrar"></a></div></div></div>' );
		}
	},
